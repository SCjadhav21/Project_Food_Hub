        ...
        <div>
            ...
            <div className='nearbyshopcontainer' >
                <div>
                    ...
                    <p>{obj.opening}</p>
                    <img src="https://developers.google.com/static/maps/images/landing/hero_maps_static_api.png" alt="" /><br />
                    <button>Get KindMeal Deals</button>
                    <button><a href={obj.directions} target='_blank' >Get Directions</a></button>
                </div>
                <div>
                    <p>Featured Deals</p>
                    {
