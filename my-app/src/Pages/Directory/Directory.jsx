...
export default function Directory() {
    ...
    useEffect(() => {
        axios.get(`https://prakash-vercel-database.vercel.app/kindmealDirectory?_page=${page}&_limit=10&q=${que}`)
    ...
    return (
        <div>
            <div className='directoryintro' >
                ...
                <p>Are you a restaurant or cafe owner? Boost your business with an attractive KindMeal profile and deals for FREE. Find out more or contact us now.</p>
            </div>
            <div className='searchdirectory' >
                <input type="text" placeholder='Search Shop Name' onChange={(e) => setText(e.target.value)} />
            ...
            <div className='directorycontainer' >
                {
                    arr && arr.map((ele) =>
                        <div key={ele.id} >
                            ...
                            <p>{ele.opening}</p>
                            <img src="https://developers.google.com/static/maps/images/landing/hero_maps_static_api.png" alt="" />
                            <div>
                                <p>Visit Website </p>
                                <a href={ele.directions} target='_blank'> Get Directions</a>
                                <p>Nearby Shops</p>
                            </div>
                        </div>
                    )
