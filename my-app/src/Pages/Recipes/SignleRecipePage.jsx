...
export default function SignleRecipePage() {
    ...
    useEffect(() => {
        axios.get(`https://prakash-vercel-database.vercel.app/kindmealRecipes/${10}`)
    ...
    return (
        <div>
            ...
            <div className='recipeimgdiscontainer' >
                ...
                <div className='recipeimgdis' >
                    ...
                    <div>
                        ...
                        <div >
                            ...
                            <p><MdOutlineFacebook color='#3b5998' /><AiFillTwitterCircle color='#00aced' /></p>
                        </div>
                    </div>
                </div>
                <div className='fullrecepi' >
                    <div>
                        ...
                        {
                            obj.ingredients && obj.ingredients.map((ele, i) => <p type='number' key={ele} >{i + 1}. {ele}</p>)
                        }
                    </div>
                    <div>
                        <h2>Directions</h2>
                        {
                            obj.directions && obj.directions.map((ele, i) => <p type='number' key={ele} >{i + 1}. {ele}</p>)
                        }
                    </div>
                </div>
            </div>
            <div className='CandRecip' >
                ...
                <div>
                    <h2>Comments</h2>
                    <p>Be the first to comment on this delicious recipe <span>No Comments</span> </p>
                    <input type="text" name="" id="" placeholder='Enter comment..' /><br />
            ...
            <div className='morerecipescontainer' >
                ...
                <div className='morepicsrecepies' >
                    {
                        obj.morepics && obj.morepics.map((ele, i) => <img key={i} src={ele} alt="" />)
                    }
                </div>
            </div>
