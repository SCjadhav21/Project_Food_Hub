  ...
  return (
    <div className='recipepage' >
      <div className='recipesintro' >
        <p>Food & Drinks   <span style={{color:'#888888'}} >|   Yummy Meat-Free Recipes</span></p>
      ...
      <div className='searchoptions' >
        <input type="text" placeholder='Search Recipe or User Name' onChange={(e) => setText(e.target.value)} />
