...
const SigleUserPage = () => {
  return (
    ...
    <div>
        ...
        <img  style={{width:"100%"}}src="https://www.kindmeal.my/photos/shop/6/604-c.jpg" />
    </div>
   ...
   <div>
    ...
    <div className='bottom'>
        <div className='left'>
            ...
            <p>Inspired by the love for animals and the planet, Hainan Village Kopitiam is an advocate of neat-free,egg & plant-based diet.And yes,our outdoor dining area is pet-friendly</p> <br />
            ...
            • Pangkor Laksa<br />
            • Special Curry Mee Hoon & Noodles<br />
            • Claypot Lou Shu Fun<br />
            • Cantonese Style Yuen Yong Noodles<br />
            • Stir-Fried Chee Cheong Fun with XO Sauce<br />
            • White Radish Pepper Soup Meehoon<br />
            • Special Fu Chuk Clear Soup Meehoon<br />
            </p>
            <br />
            <h4>All Day Breakfast</h4>
            <p>• Hainanese Butter & Kaya Toast <br />
                • Butter & Kaya Crunchy Peanut Bun <br />
                • Curry Potato with Steamed Bun <br />
                • Half-boiled Kampung Egg (2 eggs)
                </p>
                <br />
                <h4>DRINKS</h4>
                <p>***Note***</p>
...
{/* ****************** */}
        ...
        <div className='right'>
            <h3>Location</h3>
            <p>3G ,Jalan Temenggung 25/9 ,Bandar Mahota Vheras,43200 Cheras Selangor. <br />
            ...
            <p>Not required</p>
            <h4>Dining Terms</h4>
            <p>1.Additional Service Charge applicable <br />
